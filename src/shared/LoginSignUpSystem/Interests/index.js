import { Container, Button1, ButtonSignUp } from '../Login/Login.Styled'
import { BiX } from "react-icons/bi";
import { Autotravel, Interest, Notdark, Paragraph, Time, Title } from './Interests.Styled';

function Interests({setShow, setShowes,nextstep}) {
    return(
