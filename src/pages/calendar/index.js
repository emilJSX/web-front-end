...
import dayjs from "dayjs";
    ...
    function Calendar() {
        ...
        useEffect(()=> {
            ...
            const getFullCalendarDate = getFormatMonthDay +"-"+ getFormatMonth +"-"+ getFormatMonthYear
            axios.get('https://api.wishx.me/api/v1/wish/calendar', {
                params: {
        ...
        const getCalendarThisDay = () => {
            axios.get('https://api.wishx.me/api/v1/wish/calendar/day', {
                params: {
                    skip: 0,
           ...
           { show ?
            <div>
                ...
                <Datediv>
                    ...
                    <Dateblue>
                        ...
                        <p className="month_year">{getFormatMonthTxt} {getFormatMonthYear}</p>
                    </Dateblue>
            ...
            <Big_calendar_bigdiv>
                ...
                {getAllCalendar?.map((e) => (
                    <Calendar_item style={{ border: e.current == true ? "2px solid #3800B0" : ""  }} className="calendar_item">
                        <Calendar_item_item>
                            ...
                            <Calendar_item_into>
                                    ...
                                    <Link to="/my-profile/:userSlug">
                                        <Person_item_second>
                                            <Photo_cycle src={`https://api.wishx.me${data?.user?.image}`} />
                                            <User_name>{data?.user?.full_name != null ? data?.user?.full_name : 'FullName not exists' }</User_name>
                                        </Person_item_second>
                                    </Link>
                                ))}
                            ...
                            <Person_item_second>
                                <a href="#" onClick={() => {
                                    ...
                                    {
                                        (e.people_count ?   
                                        <All_wishes>See all {e.people_count} wishers</All_wishes> : ""
                                        )
                                    }
                                </a>
                            </Person_item_second>
                ...
                >
                    ...
                    {getCalendarthisday?.map((e) => (
                        ...
                        >
                                <Typography>
                                    <Middle_page_top>
                                        <Middle_top_photo src={`https://api.wishx.me${e.user.image}`}/>
                                ...
                                <Typography>
                                    ...
                                    {e.wish_list.map((wishList) => (
                                        <Card>
                                            ...
                                            <Price_div>
                                                <p className="pleft">${wishList.donate.received} raised</p>
