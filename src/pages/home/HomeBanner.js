  ...
  return (
    <div className="banner__bg">
      ...
      <div className="banner__container">
        ...
        <div className="flex min-h-[80vh] flex-col items-center justify-content-center mt-[8vh]">
          <div className="flex flex-col -mt-16 md:mt-0 items-center justify-center align-self-center justify-self-center">
            <h1 className="banner__title">
              Give <br />
              yourself <br />
              emotions
            </h1>
            <div className="flex md:mb-[130px] flex-wrap items-center gap-8 mt-4 md:mt-8 md:px-0 px-12">
              <button
