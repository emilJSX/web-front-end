...
import { Body, ButtonSection, DateSection, LeftSection, CardLong, FollowersSection, Follower, Following, Details, Edit, Final, Date, DateText, Text, TagName, Firstprice, Namesurname, Imagess, LastDiv, Lastprice, Price, SosialN, Target, TargetFinal, Title, SocialSection, Joined, UserDesc, LeftRightPriceDisplay, LeftPrice, RightPrice, MenuScrollCards, DisplayDateBirthaySection, MobileBtnSection, FotoSection, MenuScrollCardsDesktop, MobileTopCoverImageSection } from './MyProfile.style'
                        ...
                        <Grid.Col className='col-one' xl={3} lg={3} md={3} sm={12} xs={12}>
                            <div className='leftsection-style'>
                                ...
                                <LeftSection>
                                    ...
                                    <FollowersSection>
                                        <Follower>{UserInfoProfile?.contacts?.followers} <br /> <span style={{ fontSize: "12px" }}>followers</span></Follower>
                                        <Following>{UserInfoProfile?.contacts?.follows}  <br /> <span style={{ fontSize: "12px" }}>followings</span></Following>
                                    </FollowersSection>
                                    <SocialSection>
                                        <BsFacebook style={{
